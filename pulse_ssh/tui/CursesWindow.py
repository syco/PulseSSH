...
class CursesWindow:
    ...
    def _build_tree_structure(self):
        ...
        for conn_uuid, conn in globals.connections.items():
            folder = conn.folder
            if not folder:
    ...
    def _search_tree(self, tree, query):
        ...
        for key, value in tree.items():
            if isinstance(value, dict):
                ...
                conn_details = globals.connections.get(value)
    ...
    def _curses_main(self, stdscr):
        ...
        while True:
            ...
            if key == 32:
                ...
                if uuid_to_execute:
                    conn_details = globals.connections.get(uuid_to_execute)
                    if conn_details:
                        final_cmd, proxy_port = utils.build_ssh_command(globals.appy_config, conn_details)
